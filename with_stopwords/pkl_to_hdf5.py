...
def convert_to_hdf5(x):
    ...
    f= open('/home/s/Desktop/CNN/review_data_with_stopwords_10k/star_rating/stars_review.txt','r+')
    stars = []
    for line in f:
    ...
    with h5py.File('/home/s/Desktop/CNN/review_data_with_stopwords_10k/h5_data_1/train_data.h5', 'w') as hf:
        hf.create_dataset('data', data=x_train)
        hf.create_dataset('label', data=y_train)
    with h5py.File('/home/s/Desktop/CNN/review_data_with_stopwords_10k/h5_data_1/test_data.h5', 'w') as hf:
