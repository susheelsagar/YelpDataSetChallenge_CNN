...
def word2vec():
    ...
    sentences = MySentences('/home/s/Desktop/CNN/review_data_without_stopwords/text_review') # a memory-friendly iterator
    ...
    cPickle.dump( x_train, open("review_data/vector2.pkl", "wb"))
